    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <header className="relative flex min-h-screen flex-col items-center justify-center px-6">
        ...
        <div className="relative z-10 max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-1.5 text-[11px] text-gray-600">
      ...
      <section className="relative py-24 px-6">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight">Install &amp; Run</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-base font-semibold text-gray-200">Open a Terminal</h3>
                  <p className="mt-1 text-sm text-gray-500">You need a command line window to run the commands below.</p>
                  <div className="mt-4 grid gap-3 sm:grid-cols-3">
                    <div className="rounded-xl border border-white/5 bg-white/[0.03] p-4">
                      <div className="text-sm font-medium text-gray-200 mb-1">Windows</div>
                      <p className="text-xs text-gray-500">Press <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">Win + R</code>, type <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">powershell</code>, press Enter</p>
                      <p className="text-[11px] text-gray-600 mt-1">Or search "PowerShell" in the Start menu</p>
                    </div>
                    <div className="rounded-xl border border-white/5 bg-white/[0.03] p-4">
                      <div className="text-sm font-medium text-gray-200 mb-1">macOS</div>
                      <p className="text-xs text-gray-500">Press <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">Cmd + Space</code>, type <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">Terminal</code>, press Enter</p>
                    </div>
                    <div className="rounded-xl border border-white/5 bg-white/[0.03] p-4">
                      <div className="text-sm font-medium text-gray-200 mb-1">Linux</div>
                      <p className="text-xs text-gray-500">Press <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">Ctrl + Alt + T</code></p>
                      <p className="text-[11px] text-gray-600 mt-1">Or search "Terminal" in applications</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-sm font-bold text-white">2</div>
                <div className="flex-1">
                  <h3 className="text-base font-semibold text-gray-200">Install Docker Desktop</h3>
                  <p className="mt-1 text-sm text-gray-500">Click the download link for your operating system, run the installer, and follow the prompts.</p>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="rounded-xl border border-blue-500/10 bg-blue-500/5 p-4">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-xs text-gray-400">
                        ...
                        <li>Click "Install" and restart your computer when asked</li>
                        <li>After restart, open Docker Desktop and wait until it says "Docker Desktop is running" in the system tray</li>
                      </ol>
                    </div>
                    ...
                    <div className="rounded-xl border border-orange-500/10 bg-orange-500/5 p-4">
                      ...
                      <div className="rounded-lg bg-black/30 p-3 font-mono text-xs text-emerald-400 leading-relaxed">
                        <p className="text-gray-500"># Install Docker Engine</p>
                        <p>curl -fsSL https://get.docker.com | sh</p>
                        <p className="mt-1 text-gray-500"># Add your user to docker group (avoids sudo)</p>
                  ...
                  <div className="mt-4 rounded-lg bg-emerald-500/5 border border-emerald-500/10 p-3 text-xs text-emerald-300">
                    <strong>Verify Docker is running:</strong> Open a terminal and type <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">docker --version</code>. You should see a version number like <code className="rounded bg-white/5 px-1 py-0.5 text-emerald-400">Docker version 24.x</code>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 text-sm font-bold text-white">3</div>
                <div className="flex-1">
                  ...
                  <div className="mt-3 rounded-xl border border-white/5 bg-white/[0.03] p-5">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-300">Option B: Git Clone (requires Git installed)</span>
                    </div>
                  ...
                  <p className="mt-3 text-xs text-gray-500">The first run downloads ~1 GB of dependencies. Subsequent starts take ~10 seconds.</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 text-sm font-bold text-white">4</div>
                <div className="flex-1">
                  <h3 className="text-base font-semibold text-gray-200">Use the Pipeline</h3>
                  <p className="mt-1 text-sm text-gray-500">Enter a gene name and upload mutation data. The pipeline handles the rest.</p>
          ...
          <div className="mt-6 rounded-2xl border border-amber-500/10 bg-amber-500/5 p-6">
            ...
            <div className="space-y-3 text-xs text-gray-400">
              ...
              <div>
                <strong className="text-gray-300">Windows: "docker" command not found:</strong> Make sure Docker Desktop is running (check system tray). You may need to restart PowerShell after installing.
              </div>
              <div>
                <strong className="text-gray-300">Pipeline seems stuck on IEDB:</strong> Large sequences take time. Check the progress message in the UI. The pipeline auto-chunks sequences &gt;2000 amino acids.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-24 px-6">
        <div className="mx-auto max-w-3xl text-center">
          <a href="https://github.com/biranjan01/neopeptide" target="_blank" rel="noopener noreferrer"
            className="group inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.03] px-8 py-4 transition-all hover:border-white/20 hover:bg-white/[0.05]">
            ...
            <div className="text-left">
              <div className="text-sm font-semibold text-gray-200 group-hover:text-white transition-colors">View on GitHub</div>
              <div className="text-[11px] text-gray-500">biranjan01/neopeptide</div>
            </div>
          </a>
        </div>
      </section>
